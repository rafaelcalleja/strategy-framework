...
{if isset($smarty.get.step) && $smarty.get.step > 0 }
	...
	{if $smarty.get.step == 3}
		...
		{if !$noPay && $isFree && $mustPayCompanies}
			...
			<p>
				To hire the premium plan click here: <a class="btn"><span><span> <img src="{$smarty.const.RESOURCES_DOMAIN}/img/common/certified.png" /> {$lang.contratar_plan_premium}</span></span></a> and you complete the pay process in order to benefit from all the dokify advantages.				
			</p>
		{elseif $isFree}
			<p>

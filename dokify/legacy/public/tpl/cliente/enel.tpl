...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<link rel="stylesheet" href="{$resources}/css/class.css.php" type="text/css"/>
	<link rel="stylesheet" href="{$resources}/css/botones.css.php" type="text/css"/>	
	<link rel="stylesheet" href="{$resources}/css/cliente/enel/login.css" type="text/css"/>

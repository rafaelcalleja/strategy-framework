...
var kMinScale = 0.25;
var kMaxScale = 4.0;
var kImageDirectory = '../img/pdf.js/';
...
var PDFView = {
  ...
  load: function pdfViewLoad(data, scale) {
    ...
    for (var i = 1; i <= pagesCount; i++) {
	  ...
	  if( sidebar ){
      	var thumbnailView = new ThumbnailView(sidebar, page, i, page.width / page.height);
      	bindOnAfterDraw(pageView, thumbnailView);
	  }

      pages.push(pageView);
      if( sidebar ){ thumbnails.push(thumbnailView); }

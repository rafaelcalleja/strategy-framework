 ...
 */
class ProjectUrlMatcherLegacy extends Symfony\Component\Routing\Matcher\UrlMatcher
{
        ...
        switch ($pathinfo) {
            ...
            default:
                $routes = array(
                    ...
                    '/redirect/outside' => array(array('_route' => 'redirect-outside', '_controller' => 'Legacy::show', '_before' => array('login:noChecks')), 'redirect.example.com', array('GET' => 0), array('https' => 0)),
                );
